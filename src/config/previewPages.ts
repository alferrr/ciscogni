...
export const PREVIEW_PAGES: PreviewPage[] = [
  ...
  { id: "sk-dashboard", label: "Dashboard", category: "Loading States" },
  { id: "sk-leaderboard", label: "Leaderboard", category: "Loading States" },
  { id: "sk-profile", label: "Profile", category: "Loading States" },
  { id: "sk-onboarding", label: "Onboarding", category: "Loading States" },
  { id: "sk-quiz-progress", label: "Quiz (progress bar)", category: "Loading States" },
  { id: "sk-quiz-timer", label: "Quiz (timer)", category: "Loading States" },
  { id: "sk-admin-dash", label: "Admin Dashboard", category: "Loading States" },
  { id: "sk-admin-table", label: "Admin Table", category: "Loading States" },
  { id: "loader-spinner", label: "Loader (spinner)", category: "Loading States" },
